...
public class StudentAIController {
    ...
    public Result<?> getSkillTree(String  prompt) throws NoApiKeyException, InputRequiredException {
    ...
    public Result<?> teachingPlan(String  prompt) throws NoApiKeyException, InputRequiredException {
        ApplicationParam param = ApplicationParam.builder()
                .apiKey(System.getenv(apikey))
